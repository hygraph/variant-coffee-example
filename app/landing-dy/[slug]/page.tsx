...
export async function generateMetadata({ params, searchParams }: Args) {
  ...
  let landingPage = await getLandingPageBySlug(slug, undefined, undefined);
    ...
    <main className="min-h-screen">
      ...
      {hero && (
        <section className="relative h-[70vh] min-h-[500px] w-full overflow-hidden">
          ...
          <div
            id="hero-content"
            className="relative h-full flex flex-col justify-center items-start px-6 md:px-12 lg:px-24"
          >
